...
class School extends VoteModel
{
    ...
    const MIN_REPUTATION_SCHOOL_CREATE                       = -4;
    const MIN_REPUTATION_SCHOOL_VOTE                         = -4;
    const MIN_REPUTATION_FOR_ADD_REPUTATION_SCHOOL_VOTE_LIKE = -3;
    const MAX_REPUTATION_FOR_ADD_REPUTATION_SCHOOL_VOTE_LIKE = 10;
    ...
    {
        if ($this->alias) {
            $params = ['school/view', 'alias' => $this->alias];
